...
export function DashboardPage() {
  ...
  return (
    <>
      ...
      {showNamePopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <form
            ...
            className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-[#1c1c1f]"
          >
            ...
            <input
              ...
              autoFocus
              className="mt-5 w-full rounded-lg border border-ink-200 bg-white px-3 py-2 text-sm outline-none focus:border-accent dark:border-white/10 dark:bg-[#27272a] dark:text-white"
            />

            <button
              type="submit"
              disabled={!nameInput.trim()}
              className="mt-4 w-full rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Continue
            </button>
          </form>
      ...
      <div className="relative mx-auto max-w-6xl space-y-7 px-6 py-8">
        {/* page header */}
        <header className="db-rise flex items-end justify-between gap-4">
          <div>
        ...
        <section className="db-rise db-rise-2 grid gap-3 lg:grid-cols-5">
          <ProjectsPanel
            projects={projects}
